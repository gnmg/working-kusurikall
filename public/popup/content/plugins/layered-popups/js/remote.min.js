...
function ulp_subscribe_social(a,b,d,c){if(ulp_subscribing)return!1;ulp_subscribing=!0;var f=jQuery(a).parents(".ulp-inline-window").attr("id");if(f)return _ulp_inline_subscribe_social(f,a,b,d,c),!1;f="";var e=jQuery(a).attr("data-fa");e?(e="<i class='"+e+"'></i>&nbsp; ",f="<i class='fas fa-spinner fa-spin'></i>&nbsp; "):e="";var h=jQuery(a).attr("data-label"),g=jQuery(a).attr("data-loading");g&&""!=g||(g="Loading...");jQuery(a).html(f+g);c={"ulp-name":c,"ulp-email":d,"ulp-phone":"","ulp-message":"",
...
function _ulp_inline_subscribe_social(a,b,d,c,f){var e=jQuery("#"+a).attr("data-id"),h="",g=jQuery(b).attr("data-fa");g?(g="<i class='"+g+"'></i>&nbsp; ",h="<i class='fas fa-spinner fa-spin'></i>&nbsp; "):g="";var k=jQuery(b).attr("data-label"),l=jQuery(b).attr("data-loading");l&&""!=l||(l="Loading...");jQuery(b).html(h+l);f={"ulp-name":f,"ulp-email":c,"ulp-phone":"","ulp-message":"","ulp-popup":e,"ulp-campaign":"",action:"ulp_subscribe"};"undefined"!==typeof JSON?f={action:action,encoded:!0,data:ulp_encode64(JSON.stringify(f))}:
