                ...
                <div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                    <div class="service_content_box relative-position">
                        ...
                        <div class="service_text_box saas2-headline pera-content">
                            <h3>電話でお知らせ</h3>
                            <p>
                                ご自宅の固定電話に1日3回まで、お薬の時間にお電話をします。<br><br>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="service_content_box relative-position">
                        ...
                        <div class="service_text_box saas2-headline pera-content">
                            <h3>個人メッセージの内容</h3>
                            <p>
                                メッセージの内容はパーソナライズされているので薬の種類と量をメッセージで伝えることができます。
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="s2_faq">
                            ...
                            <div id="collapse1" class="collapse" data-parent="#accordionExample">
                                <div class="s2_faq-body">
                                    はい。ご登録後21日間、無料でお試しいただけます。22日目にご登録されたクレジットカードから決済、毎月同じ日にお支払いとなります。
                                </div>
                            </div>
                        </div>
                        <div class="s2_faq">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-10 col-md-12 jp-font">
                <p>「薬コール」をはじめようと思ったのは、私自身がその必要性を体感していたからです。
                    私は去年、腎臓移植手術を受けました。移植を受けた人にとって、免疫抑制剤を毎日、決められた時間に服用することはとても大切なことです。はじめはスマートフォンのアプリを使用していましたが、私の場合、常に身に付けているわけではなく、アプリのアラームが聞えない事がよくありました。一方で家の固定電話ならいつでも聞こえることから、このサービスの必要性を実感しました。
                </p>
                ...
                <p>「薬コール」はお父様、お母様、またはご家族の方がきちんとクスリを服用できるようにお手伝いします。そして、あなたがご家族の毎日の薬の時間を心配するストレスを軽減します。最初のコール（電話の呼び出し）に出ない場合、５分間隔で更に２回コールします。もし３回目までの電話に出ない場合は、事前に登録いただいているメールアドレスに、クスリを飲み忘れている可能性があることをご連絡します。電話に出ないことがすぐにわかるので、その時点でご家族の方が対応可能になります。
                </p>
            </div>
