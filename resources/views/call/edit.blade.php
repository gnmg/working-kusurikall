        ...
        <div class="bg-white my-4 shadow p-8 w-full lg:w-3/5 items-center">
            ...
            <div class="w-full mb-4">
                <div class="">
                    ...
                    <div class="block text-xs text-gray-600 md:text-base mb-2 mr-3 mt-3">
        ...
        <div class="bg-white my-4 shadow p-8 w-full lg:w-3/5 items-center">
            ...
            <div class="w-full mb-4">
                <div class="">
                    ...
                    <div class="block text-xs text-gray-600 md:text-base mb-16 mr-3 mt-3">
            ...
            <div class="w-full mb-4">
                <div class">
                    ...
                    <input type="text" id="phone_numbers" name="phone_numbers"
                        ...
                        value="{{ old('phone_numbers',$call->phone_numbers) }}">

<div class="block text-xs text-gray-600 md:text-base mb-16 mr-3 mt-3">{{ __("Enter phone number with country code. e.g +81<10-digit-mobile>")}}</div>
                ...
                <div class="">
                    ...
                    <label class="inline-flex items-center">
                        <input type="radio" id="message_voice" name="message_voice" value="Male" class=""
                            placeholder="Message Voice" {{ (old('message_voice',$call->message_voice)) == 'Male' ? 'checked' : '' }}>
                        <span class="ml-2">{{ __('lang.male')}}</span>
                    </label>
                    <label class="inline-flex items-center ml-6">
                        <input type="radio" id="message_voice" name="message_voice" value="Female" class=""
                            placeholder="Message Voice" {{ (old('message_voice',$call->message_voice)) == 'Female' ? 'checked' : '' }}>
            ...
            <div class="w-full mb-4">
                <div class="">
                    <label for="sos" class="block text-lg mb-2 mr-3 mt-3">{{ __('lang.turn_on_alert_message')}}<span
                            class="text-sm bg-red-400 text-white rounded-sm px-1 py-0.5 ml-1">必要</span></label>
                    <label class="inline-flex items-center">
                        <input type="radio" id="sos" name="sos" value="yes" class="" placeholder="Message Voice" {{ (old('sos',$call->sos)) == 'yes' ? 'checked' : '' }} >
                        <span class="ml-2">{{ __('lang.yes')}}</span>
                    </label>
                    <label class="inline-flex items-center ml-6">
                        <input type="radio" id="sos" name="sos" value="no" class="" placeholder="Message Voice" {{ (old('sos',$call->sos)) == 'no' ? 'checked' : '' }}>
                ...
                <div class="w-full mb-4">
                    <div class="mb-16">
                        ...
                        <input type="text" id="sos_email" name="sos_email"
                            ...
                            placeholder="Enter the email address of the" value="{{old('sos_email',$call->sos_email) }}">
                        @error('sos_email')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                            @enderror
