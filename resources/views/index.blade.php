        ...
        <div class="remind__inner inner">
            ...
            <div class="remind__contents">
                ...
                <div class="remind__excerpts">
                    <p class="remind__excerpt">「薬コール」をはじめようと思ったのは、私自身がその必要性を体感していたからです。はじめはスマートフォンのアプリを使用していましたが、私の場合、常に身に付けているわけではなく、アプリのアラームが聞こえない事がよくありました。一方で家の固定電話ならいつでも聞こえることから、このサービスの必要性を実感しました。</p>
                    <p class="remind__excerpt">同じ状況のお年寄りの方々も多くいらっしゃいます。最新のスマートフォンを使いこなすのはなかなか難しく、使い慣れている家の固定電話がストレスにならずに薬の飲み忘れを防ぐお手伝いになります。</p>
                    <p class="remind__excerpt">世界保健機関（WHO）によると、患者さんの約半数の人が処方された薬を指示通りに服用していないそうです。<br>年配の患者さんやアルツハイマーの患者さんにおいては更に飲み忘れの割合が高いと言うことです。</p>
                    <p class="remind__excerpt">アルツハイマーを患っている方や、年配の方々においては薬の飲み忘れは単にご本人のみの問題ではありません。<br>家族やケアテイカーの方々が毎日確認したり、リマインドしなければならないため、負担も大きくなります。</p>
                    <p class="remind__excerpt">きちんと処方通りに薬を服用することが、より良い健康維持に繋がります。</p>
                    <p class="remind__excerpt">「薬コール」はお父様、お母様、またはご家族の方がきちんと薬を服用できるようにお手伝いします。そして、あなたがご家族の毎日の薬の時間を心配するストレスを軽減します。</p>
                </div>
            </div>
        </div>
        ...
        <div class="question__inner inner">
            ...
            <div class="question__items">
                <div class="question__item">
                    ...
                    <div class="question__item-answer ">はい。キャンセル後も決まったお支払い日まではサービスを受けることができます。</div>
                </div>
                <div class="question__item">
                    <div class="question__item-question">
